...
class Qrgernerator:
    def __init__(self,root):
        ...
        text=Label(self.root,text="   Qr code Generator for Skfund Members",font=("times new roman",30),fg='White',bg='#053246',anchor='w').place(x=0,y=0,relwidth=1)
        ...
        ent_emp_code=Entry(emp_frame,font=("times new roman",15,'bold'),bg='lightyellow',textvar=self.var_emp_code)
        ent_emp_code.place(x=185,y=60)

        ent_emp_fname=Entry(emp_frame,font=("times new roman",15,'bold'),bg='lightyellow',textvar=self.var_emp_fname)
        ent_emp_fname.place(x=185,y=100)

        ent_emp_lname=Entry(emp_frame,font=("times new roman",15,'bold'),bg='lightyellow',textvar=self.var_emp_lname)
        ...
        btn_save=Button(emp_frame,text="Save",bg="#497e1e",fg="white",font=("times new roman",15,'bold'),command=self.generate)
