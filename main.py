...
class Qrgernerator:
    def __init__(self,root):
        ...
        ent_emp_mno=Entry(emp_frame,font=("times new roman",15,'bold'),bg='lightyellow')
        ent_emp_mno.place(x=185,y=180)

        ent_emp_ano=Entry(emp_frame,font=("times new roman",15,'bold'),bg='lightyellow')
        ...
        emp_title=Label(qr_frame,text="Qr Show",font=("goudy old style",20),bg=primary_color,fg="white")
        emp_title.place(x=0,y=0,relwidth=1)
